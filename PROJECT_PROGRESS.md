...
| WEB-001 Public Homepage                                    | Complete                              | Homepage refreshed to follow `vivah_australia_ui_ux_planning.md`, with sticky nav, premium hero, quick signup/search card, trust bar, featured approved profiles API, active plans API, safety, stories, blog, FAQ, community links, and final CTA. |
