...
- Public/member frontend alignment sprint FE-001 audit, FE-002 shared design system, FE-003 shared public/member layout, and FE-004 clickable profile cards are complete in `FRONTEND_PROGRESS.md` and `UI_UX_TASKLIST.md`; feature-level page redesign work remains pending.
