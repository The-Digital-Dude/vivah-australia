...
| COMMUNITY-001 Rooms                                        | Complete for sprint scope             | Community room model, default room provisioning, public room list/detail endpoints, admin room create/update endpoints, member community room UI, admin community room UI, audit logs, and tests. Archive/delete room workflow remains.                                                                                 |
| COMMUNITY-002 Posts, Comments, Reactions                   | Complete for sprint scope             | Post/comment/reaction models, post feed/create/edit/delete APIs, comment/reaction/report endpoints, moderator post status control, member community composer/feed/actions, admin moderation integration, and tests. Dedicated comment thread UI and bulk moderation remain.                                             |
