...
export function BentoSuccessStories() {
  return (
    <section className="relative z-20 overflow-hidden bg-transparent py-24">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <h2 className="font-playfair text-4xl font-bold text-[#2A111A] sm:text-5xl">Marriages Made in Australia. Rooted in Tradition.</h2>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {storyCards[0] && (
            <motion.article
              ...
              className="group relative h-[420px] overflow-hidden rounded-sm border-[8px] border-white bg-gradient-to-br from-white to-[#FDFBF7] shadow-[0_40px_100px_rgba(217,160,91,0.15)] ring-1 ring-[#D9A05B]/30 sm:h-[520px]"
            >
              <Image
          ...
          <div className="grid gap-6">
            {storyCards.slice(1, 3).map((story, i) => (
              <motion.article
                ...
                className="group relative h-[248px] overflow-hidden rounded-sm border-[6px] border-white bg-gradient-to-br from-white to-[#FDFBF7] shadow-[0_30px_80px_rgba(217,160,91,0.1)] ring-1 ring-[#D9A05B]/20"
              >
                <Image
                  src={story.imageUrl}
                  alt={story.title}
