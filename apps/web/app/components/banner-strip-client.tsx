...
function saveDismissed(key: string) {
  try {
    ...
    if (!existing.includes(key)) {
      sessionStorage.setItem(STORAGE_KEY, JSON.stringify([...existing, key]));
    }
  } catch {
...
export default function BannerStripClient({ banners }: { banners: CampaignBannerData[] }) {
