  ...
  return (
    <div className="min-h-screen bg-brand-ivory flex flex-col font-poppins selection:bg-brand-gold/20 selection:text-brand-maroon">
      ...
      <main className="flex-1">
          ...
          <div className="bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] p-6 sm:p-8 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-stretch">
              ...
              <div className="lg:col-span-1">
                <button className="w-full h-full min-h-[50px] inline-flex items-center justify-center gap-2 rounded-xl bg-brand-maroon px-6 py-2 text-[15px] font-bold text-white transition hover:bg-brand-maroon/90 shadow-md">
        ...
        {/* CUSTOM FOOTER */}
        <footer className="bg-[#2B0A12] border-t border-brand-gold/20 py-12 lg:py-16">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr_1.5fr] gap-8 lg:gap-12">
              
              {/* Logo & Tagline */}
              <div className="col-span-2 lg:col-span-1">
                <Image src="/logo-white.png" alt="Vivah Australia" width={220} height={85} className="h-16 w-auto object-contain mb-4" />
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {['Home', 'About Us', 'Success Stories', 'Membership'].map((link) => (
                    <li key={link}><Link href="#" className="text-white/80 text-sm hover:text-brand-gold transition">{link}</Link></li>
                  ))}
                </ul>
              </div>
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-white/80 text-sm">hello@vivahaustralia.com.au</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-white/80 text-sm">1300 848 243</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-0.5 text-white/40"><svg className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg></div>
                    <span className="text-white/80 text-sm">Sydney, NSW, Australia</span>
                  </li>
                </ul>
              </div>
