...
export default function AuthShell({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-ivory text-brand-charcoal font-poppins">
      {/* Full-width header */}
      <PublicHeader />
      ...
      <div className="flex-1 grid lg:grid-cols-[1.1fr_1fr]">
        ...
        {/* Right Form Panel */}
        <main className="flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-brand-ivory">
